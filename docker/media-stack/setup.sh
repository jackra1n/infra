...
# Create directories
sudo mkdir -pv config/{sonarr,radarr,prowlarr,bazarr,qbittorrent,plex,overseer}-config
...
sudo chown -R overseer:mediacenter config/overseer-config
